...
class DiagramGenerator:
    ...
    def _create_complete_html(self, svg_content: str, legend_html: str, threat_model) -> str:
            ...
            # Load the pan-zoom script and escape curly braces for the f-string
            pan_zoom_script_path = Path(__file__).parent.parent / "server" / "static" / "js" / "svg-pan-zoom.min.js"
            with open(pan_zoom_script_path, 'r', encoding='utf-8') as f:
                pan_zoom_script = f.read().replace('{', '{{').replace('}', '}}')
