...
def test_get_framework_mitigation_suggestions_empty():
    """Test get_framework_mitigation_suggestions with an empty list of technique IDs."""
    suggestions = get_framework_mitigation_suggestions([])
    assert suggestions == []


def test_get_framework_mitigation_suggestions_no_match():
    """Test get_framework_mitigation_suggestions with a technique ID that has no mapping."""
    suggestions = get_framework_mitigation_suggestions(["T9999"])
    assert suggestions == []
